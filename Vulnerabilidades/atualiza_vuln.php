  ...
  <body>
    <div class="container">
      <div class="docs-example docs-example-form">
          <h1>Atualiza vulnerabilidade</h1>
          ...
          <div class="row" style="height: 50px">
              <input id="verify_button" style='position: absolute; right: 270px' class="button-primary" type="submit" value="Verificar" onclick="getVulnerabilityAttributes('atualiza_vuln')">
          </div>
      </div>
    </div>
  </body>
